<template>
  <div class="content">
    <div class="content__container">
      <p class="content__container__text">欢迎您</p>

      <ul class="content__container__list">
                  <li class="content__container__list__item">
          <span style="color: tan">{{ userinfo.studentId }}</span> !
        </li>
        <li class="content__container__list__item">
          <span style="color: tan">本系统仅限</span> 
        </li>
        <li class="content__container__list__item">
          <span style="color: tan">老师、学生</span> 
        </li>

        <li class="content__container__list__item">
          <span style="color: tan">查看和使用</span> 
        </li>
