    ...
    <el-card class="box-card">
      ...
      <el-card>
        ...
        >
          ...
          <el-table-column property="id" label="学号" width="120" />
          <el-table-column property="name" label="姓名" width="120" />
          <el-table-column property="e-mail" label="邮箱" width="180" />
...
// 信息存储
getrequest("/class").then((res) => {
  console.log(res)
  tableData.value = res.data.Student
});
</script>
