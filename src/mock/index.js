...
Mock.mock('/api/login', "post", (options) => {
    let data = {...options,code:200,token:'token'}
    // console.log(options)
    return data;
});

Mock.mock('/api/admin/query','post',(options)=> {
    // console.log(options)
    let data = {
        studentId:'80211312',
        nickname:'liruixiang',
        avatar:'https://p.qqan.com/up/2022-10/16655346386444929.jpg',
        sex:'男'
    }
    return data
});
